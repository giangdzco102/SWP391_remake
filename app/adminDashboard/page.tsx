          ...
          <tbody>
            {users.map((u: any) => (
              <tr key={u.id} style={trStyle}>
                ...
                <td style={td}>
                  <StatusBadge status={String(u.enabled)} />
                </td>
                <td style={td}>
                  {editRoleRow === u.id ? (
                    <div style={{ display: "flex", gap: 6 }}>
                      <ActionBtn color="#059669" onClick={() => onSave(u.id)}>
                        <Icon.Check /> Lưu
                      </ActionBtn>
                    ...
                    <ActionBtn color="#7c3aed" onClick={() => onStartEdit(u)}>
                      <Icon.Edit /> Roles
                    </ActionBtn>
                  )}
                </td>
          ...
          {stories.map((s: any) => (
            <div key={s.id} style={cardStyle}>
              ...
              >
                ...
                <ActionBtn color="#059669" onClick={() => onReview(s)}>
                  <Icon.Check /> Xem & Duyệt
                </ActionBtn>
              </div>
            </div>
          ))}
            ...
            <tbody>
              {reports.map((r: any) => (
                <tr key={r.id} style={trStyle}>
                  ...
                  <td style={td}>
                    {r.status === "PENDING" && (
                      <ActionBtn color="#059669" onClick={() => onResolve(r)}>
                        <Icon.Check /> Xử lý
                      </ActionBtn>
                    )}
                  </td>
          ...
          {missions.map((m: any) => (
            ...
            >
              ...
              <div style={{ display: "flex", gap: 14, fontSize: 13 }}>
                <span>
                  🪙 <strong>{m.coinReward}</strong> coin
                </span>
                <span>
