  ...
  useEffect(() => {
    ...
    getStories(params)
      .then((res: any) => {
        ...
        const tp = Math.ceil(totalItems / PAGE_SIZE);
...
function HotSection({ stories, loading, filters, onStory, likedStories, onLike }: {
  ...
  onStory: (s: StoryShape) => void; likedStories: number[]; onLike: (id: number, wasLiked: boolean) => void;
}) {
  return (
...
export function HomePage() {
  ...
  return (
    <div className="fade-in">
      ...
      <div className="section" style={{ paddingTop: 20, display: "flex", flexWrap: "wrap", gap: 28, alignItems: "start" }}>
